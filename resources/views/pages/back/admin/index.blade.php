        ...
        <div class="row">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <div class="row d-flex flex-align-center justify-content-center align-items-center my-lg-4">
                            ...
                            <div class="col-4 col-md-6 col-lg-3 rounded bg-white shadow p-0 mx-2 my-2 category">
            ...
            <div class="col-12 col-md-6 col-lg-6">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <div id="piechart" class="w-100 m-0 p-0 category"></div>
                    </div>
                </div>
            </div>
        </div>
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script>
            ...
            chart: {
                ...
                events: {
                    dataPointSelection: function(event, chartContext, config) {
                        ...
                        window.location.href = "{{ route('admin.dashboard') }}?keterserapan=" + selectedCategory;
                        }
                    }
                },
        ...
        $(".category").click(function() {
                ...
                window.location.href = "{{ route('admin.dashboard') }}?keterserapan=" + keterserapan;
            }
        });
